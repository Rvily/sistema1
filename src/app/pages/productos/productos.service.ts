...
import { Activities, SearchResult } from '../productos/productos/productos.model';

import { activitiesData } from '../productos/productos/productos';

import { SortDirection } from '../productos/productos/productos-sortable.directive';
...
export class ProductosService {
    ...
    constructor(private ftore:AngularFirestore) {
        this._search$.pipe(
    ...
    getProductos(): Observable<any> {
        //console.log('Services: ',this.firestore.collection('empleados').snapshotChanges())
        return this.ftore.collection('productos').snapshotChanges();
        
      }
      agregarProducto(producto: any): Promise<any> {
        return this.ftore.collection('productos').add(producto);
      }
