...
import { Activities, SearchResult } from './productos.model';

import { activitiesData } from './productos';

import { SortDirection } from './productos-sortable.directive';
...
export class ProductosService {
    ...
    constructor(private pipe: DecimalPipe, private ftore:AngularFirestore) {
        this._search$.pipe(
